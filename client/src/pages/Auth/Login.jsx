...
import { Mail, Lock, Loader2, ArrowRight, HelpCircle, Eye, EyeOff, KeyRound, ArrowLeft, Sparkles, Fingerprint, Github, Phone } from "lucide-react";

const Login = () => {
  const { login, verify2fa, loginWithPasskey, register, isAuthenticated, loading } = useContext(AuthContext);
  ...
  // Simulated Social Auth Handler for Google, Microsoft, GitHub, and Mobile login
  const handleSocialLogin = async (provider) => {
    setIsSubmitting(true);
    toast.loading(`Connecting to ${provider} authentication services...`, { id: "social-auth" });
    
    // Simulate OAuth / Mobile login handshake
    setTimeout(async () => {
      try {
