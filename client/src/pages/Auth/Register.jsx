...
const Register = () => {
  ...
  // Social Auth Handler for Google, Microsoft, GitHub, and Mobile signup
        ...
        <div className="bg-[#1E293B]/40 backdrop-blur-xl border border-[#334155]/60 rounded-2xl p-8 shadow-2xl">
          {authMode === "credentials" ? (
                  ...
                  <div className="flex justify-between items-center mt-2 text-[10px]">
                    ...
                    {cooldown > 0 ? (
                      ...
                      <button
                        ...
                        className="text-[#06B6D4] hover:underline font-semibold bg-transparent"
                      >
              ...
              {!otpSent ? (
                ...
                <div className="flex gap-3 mt-4">
                  <button
                    ...
                    className="px-4 py-3 border border-[#334155] rounded-xl text-xs text-[#CBD5E1] hover:text-white transition-all bg-transparent"
                  >
                    Edit Profile
                  </button>
                  <motion.button
            ...
            <form className="space-y-4" onSubmit={smsSent ? handleVerifyMobileSms : handleSendMobileSms}>
              ...
              {/* Invisible reCAPTCHA verification point */}
